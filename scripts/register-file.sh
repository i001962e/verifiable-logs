...
REGISTER_RESPONSE=$($CURL_BIN --silent --show-error --fail-with-body -X POST "https://aiagent.cryptowerk.com/platform/API/v8/register" \
...
printf '%s' "$REGISTER_RESPONSE" | validate_json
